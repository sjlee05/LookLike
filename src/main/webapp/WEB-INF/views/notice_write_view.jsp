...
<body>
	...
	<div class="table-wrapper">
		<table border="1" class="tab">
			<form id="frm" method="post" action="notice_write" enctype="multipart/form-data">
				...
				<tr bgcolor="#FFFAFA">
					<td>제목</td>
					<td><input type="text" name="not_title" size="50"
						style="height: 30px;"></td>
				</tr>
				<tr bgcolor="#FFFAFA">
					<td>내용</td>
					<td><textarea rows="10" cols="55" name="not_content"></textarea>
					</td>
				</tr>
				<tr bgcolor="#FFFAFA">
					<td>첨부파일</td>
				...
				<tr bgcolor="#FFFAFA">
					<td colspan="2">
						<input type="submit" value="입력" name="put" class="btn" style="padding: 8px 16px;"> &nbsp;&nbsp;
						 <a href="notice_list" class="btn" style="padding: 8px 16px;">목록보기</a>
					</td>
				</tr>
			</form>
		</table>
