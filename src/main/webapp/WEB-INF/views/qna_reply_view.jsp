...
<div class="table-wrapper">
	<table border="1" class="tab">
		<form id="frm" method="post" action="qna_reply" enctype="multipart/form-data">
			<input type="hidden" name="qna_key" value="${replyNum.qna_key}">
			<input type="hidden" name="qna_step" value="${replyNum.qna_step}">
			<input type="hidden" name="qna_level" value="${replyNum.qna_level}">
			<input type="hidden" name="qna_ref" value="${replyNum.qna_ref}">
			...
			<tr>
				<td>제목</td>
				<td>
					<input type="text" name="qna_title" size="50" style="height:30px;">
				</td>
			</tr>
			<tr>
				<td>내용</td>
				<td>
					<textarea rows="10" cols="55"  name="qna_content"></textarea>
				</td>
			</tr>
			<tr>
				<td>첨부파일</td>
