		...
		<form id="frm" method="post" action="admin_registerOk">
			<div class="signup">
				<h2 class="form-title" id="signup">
					<span>or</span>Manager Sign up
				</h2>
				<div class="form-holder">
					<input type="id" class="input" placeholder="id" name="ad_id" />
		...
		<div class="login slide-up">
			<div class="center">
				...
				<form method="post" name="login_frm" action="admin_loginOk">
					...
					<input type="button" class="submit-btn" id="login-btn" value="Manager Log in"> <a href="#" class="forget-id-pw">Forget
						ID or Password</a>
				</form>
			</div>
		</div>
...
// 					 location.href="loginOk";
	...
	<div class="footer"><%@ include
			file="/WEB-INF/views/include/footer.jsp"%></div>
</body>
</html>