...
<div class="table-wrapper">
	<table border="1" class="tab">
		...
		<tr height="50px">
			<td colspan="5">
			<input type="button"  value="글작성"  class="btn" onclick="location.href='qna_write_view'" style="padding: 8px 16px;">
			</td>
		</tr>
	</table>
</div>
...
<script>
	...
	$(".move_link").on("click",function(e){
		...
		var bno = actionForm.find("input[name='qna_key']").val();
		if (bno != ''){
			actionForm.find("input[name='qna_key']").remove();
		}
